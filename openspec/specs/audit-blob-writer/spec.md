# audit-blob-writer Specification

## Purpose
Defines opt-in MiniBus audit record contracts and Azure Blob Storage audit writing behavior for processed inbound messages.
